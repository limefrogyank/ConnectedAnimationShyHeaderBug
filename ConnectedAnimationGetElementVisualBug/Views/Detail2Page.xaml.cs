...
{
    public sealed partial class Detail2Page : Page, INotifyPropertyChanged
    {
        ...
        {
            InitializeComponent();
            this.Loaded += Detail2Page_Loaded;
        }
        ...
        private void Detail2Page_Loaded(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
