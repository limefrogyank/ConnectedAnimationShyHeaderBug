...
{
    public sealed partial class Detail3Page : Page, INotifyPropertyChanged
    {
        ...
        {
            InitializeComponent();
            this.Loaded += Detail3Page_Loaded;
        }
        ...
        private void Detail3Page_Loaded(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            ...
            animation.Completed += (s2, e2) =>
            {
                ...
                //MANUALLY ADJUST OFFSETS TO MATCH THE ORIGINAL MARGIN
                profileVisual.Offset = new Vector3(20, 83, 0);
